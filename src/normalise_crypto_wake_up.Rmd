...
kallcounts_bygene_fcfile <-
    here::here("data","CW_kallisto_abundance_foldchang_long_by_gene.txt")

write_lines(c("# CW_kallisto_abundance_foldchange_long_by_gene.txt",
...
sample_metadatafile <- here::here("data","crypto_wake_up_sample_sheet_plus_tags.txt")

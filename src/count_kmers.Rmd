...
```{r write-5mers-H99-promoters}
promoter_5mer_counts_file <-
    here::here("data","H99_all_genes_promoter_500nt_5mer_counts.tsv.gz") %>%
    gzfile("w" )

write_lines(c("# H99_all_genes_promoter_500nt_5mer_counts.tsv",
...
```{r write-5mers-H99-terminators}
terminator_5mer_counts_file <-
    here::here("data/misc","H99_all_genes_terminator_250nt_5mer_counts.tsv.gz") %>%
    gzfile("w" )

write_lines(c("# H99_all_genes_terminator_250nt_5mer_counts.tsv",
